...
class NoteEntryAdapterTitles(val clickListener: NoteEntryTitlesListener) : ListAdapter<NoteEntry,
        NoteEntryAdapterTitles.ViewHolder>(NoteEntryTitlesDiffCallback()) {
